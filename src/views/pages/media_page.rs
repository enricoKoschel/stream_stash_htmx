...
pub fn media_page(
    ...
    main_layout(html! {
        // top-0 on mobile, top-16 for navbar on desktop
        (image_with_fallback("fixed inset-0 sm:top-16 w-full h-full -z-1 opacity-20 object-cover", "aspect-16/9", backdrop_url));
